            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Operator Registration</h2>
                        <form method="POST" action="{{route('admin@signup')}}" class="register-form" id="register-form">
                            @csrf
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="admin" id="admin" placeholder="Admin Name" required/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="{{ route('admin@signin') }}" class="signup-image-link">I am already an admin</a>
                    </div>
                </div>
            </div>
        </section>
