...
<div class="invoice-area">
    <div class="invoice-wrapper">
        <div class="invoice-header">
            <div class="invoice-flex-contents">
                ...
                <div class="invoice-header-contents" style="float:right;margin-top:-120px;">
                    <h1 class="invoice-title">{{ __('DAILY REPORT') }}</h1>
                </div>
            </div>
        </div>
        <div class="invoice-details">
            <div class="invoice-details-flex">
                ...
                <div class="invoice-single-details" style="float:right;margin-top:-100px;">
                    <h1></h1>
                    <h4 class="invoice-details-title">{{ session('name') }}</h4>
        ...
        <div class="item-description">
            <h5 class="table-title">{{ __('TODAY\'S SOLD') }}</h5>
            <table class="custom--table">
                <thead class="head-bg">
                <tr> 
                    <td>{{ __('Date & Time') }}</th>
                    <td align="center">{{ __('Total Ticket') }}</th>
                    <td align="right">{{ __('Total Price') }}</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td>{{date('d-m-y h:i:s')}}</td>
                    <td align="center">{{__('1')}}</td>
                    <td align="right">{{__('Tk 500')}}</td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="item-description">
            <div class="table-responsive">
                <h5 class="table-title"> {{ __('TOTAL SOLD') }} </h5>
                <table class="custom--table">
                    <thead class="head-bg">
                    <tr> 
                        <td>{{ __('Date & Time') }}</th>
